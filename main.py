...
def main() -> int:
    ...
    print(
        "Usage: python main.py {ingest,normalize,compute_statistics,backtest,rank_breaks,audit_candidates,analyze_agents,lemonade_debug,detect_artifacts,list_forecasters,backtest_advanced,draft_paper}"
    )
    return 2
